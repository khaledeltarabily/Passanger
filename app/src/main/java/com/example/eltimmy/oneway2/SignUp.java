                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){ // if this Email Work
                            ...
                            UserInfo RegistereduserInfo = new UserInfo(Name,phone,password);



                            databaseReference.child("passengers").child(User.getUid()).setValue(RegistereduserInfo); //Enter information to database
                            storageReference.child("passengers").child(imageUri.getLastPathSegment()).putFile(imageUri);
